                                ...
                                <div class="relative flex">
                                    ...
                                    <div class="flex flex-col">
                                        <div>
                                            ...
                                            <strong class="text-gray-800">{{ $comment->user->name ?? 'Usuario no encontrado' }}</strong>
                                            </a>
                                            @if (Auth::id() === $comment->userId)
                                                <div class="relative inline-block text-left">
                                                    ...
                                                    <!-- Menú de opciones -->
                                                    <div
                                                        class="menu hidden origin-top-right absolute z-50 left-0 mt-2 w-32 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                                                        <div class="py-1" role="menu" aria-orientation="vertical"
                                                            ...
                                                            <div
                                                                class="origin-top-right absolute z-50 left-32 rounded-md top-0 w-60 shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                                                                <form
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        <x-heroicon-o-check id="UpdateComment"
                                                                            class="h-5 w-5" />
                                                                    </button>
                                                                </form>
                                                            </div>
